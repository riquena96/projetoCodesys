...
angular.module('app.controllers')
    .controller('LoginModalController',
        ['$rootScope', '$scope', '$location', '$cookies',
        ...
        return {
            ...
            responseError: function responseError(rejection) {
                ...
                if (401 === rejection.status
                    && rejection.data && "access_denied" === rejection.data.error || rejection.headers
...
angular.module('app.services')
    .service('ProjectFile',
        ['$resource', 'appConfig', 'Url', function ($resource, appConfig, Url) {
    ...
    .service('ProjetoUsuario',
        ['$resource', '$filter', '$httpParamSerializer', 'appConfig',
            function ($resource, $filter, $httpParamSerializer, appConfig) {
                ...
                return $resource(appConfig.baseUrl + '/project', {
                    get: {
                        method: 'GET',
                        transformResponse: function (data, headers) {
                            var o = appConfig.utils.transformResponse(data, headers);
...
angular.module('app.controllers')
    .controller('ProjectNoteShowController', ['$scope', 'Client', function ($scope) {
    }]);
angular.module('app.controllers')
