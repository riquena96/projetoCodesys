...
CREATE TABLE `project_members` (
  ...
  `excluido` bit(1) DEFAULT b'0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `project_member` (`project_id`,`member_id`),
  KEY `project_members_member_id_foreign` (`member_id`),
  CONSTRAINT `project_members_member_id_foreign` FOREIGN KEY (`member_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
-- Dump completed on 2017-07-09  0:54:49
